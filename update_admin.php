...
/**
 * admin.php 自动更新脚本
 * 使用方法：在浏览器访问这个文件，即可从 GitHub 仓库拉取最新的 admin.php
 */

// 1. 使用国内加速代理拉取你仓库里完好的原版 admin.php
// 多个代理地址，如果第一个失败会自动尝试下一个
$proxies = [
    "https://ghproxy.net/https://raw.githubusercontent.com/wsdwz/chat/main/admin.php",
    "https://mirror.ghproxy.com/https://raw.githubusercontent.com/wsdwz/chat/main/admin.php",
    "https://ghp.ci/https://raw.githubusercontent.com/wsdwz/chat/main/admin.php",
    "https://raw.githubusercontent.com/wsdwz/chat/main/admin.php"  // 备用：直接拉取
];

// 2. 目标文件路径
$targetFile = __DIR__ . '/admin.php';

// 3. 备份文件路径
$backupFile = __DIR__ . '/admin.php.backup.' . date('YmdHis');

echo "<!DOCTYPE html><html><head><meta charset='utf-8'><title>admin.php 更新工具</title>";
...
echo "<div class='box'><h1>🔄 admin.php 自动更新工具</h1>";
echo "<p class='info'>从 GitHub 仓库拉取最新的 admin.php 文件</p></div>";
...
if (file_put_contents($targetFile, $content) !== false) {
    ...
    echo "<hr>";
    echo "<p class='success'>✨ 操作完成！你现在可以刷新页面查看最新的 admin.php</p>";
    echo "<p><a href='admin.php' style='color:#007bff;text-decoration:none;'>➡️ 点击这里访问 admin.php</a></p>";
    ...
    echo "<p>2. 手动替换服务器上的 admin.php 文件</p>";
}
...
$backupFiles = glob(__DIR__ . '/admin.php.backup.*');
...
echo "<h3>📝 使用说明</h3>";
echo "<ul>";
echo "<li>这个脚本会自动从 GitHub 仓库拉取最新的 admin.php</li>";
echo "<li>更新前会自动备份现有文件</li>";
echo "<li>如果需要恢复，可以使用备份文件还原</li>";
echo "<li><strong>建议：</strong>更新后测试管理功能是否正常</li>";
echo "<li><strong>注意：</strong>更新后请检查管理员配置是否需要重新设置</li>";
echo "</ul>";
echo "<hr>";
